...
const EindhovenBookingPage = () => {
    ...
    const popularRoutes = Object.entries(fixedRoutes["Eindhoven Airport (EIN)"]).flatMap(([destination, prices]) => 
    ...
    return (
        <>
            <Head>
                <title>{t('airports.eindhoven.pageTitle')}</title>
                <meta name="description" content={t('airports.eindhoven.metaDescription')} />
                <meta name="keywords" content={t('airports.eindhoven.metaKeywords')} />
            </Head>
            ...
            <div className="min-h-screen bg-gradient-to-br from-primary via-primary/95 to-primary/90 relative overflow-hidden">
                        ...
                        <div className="space-y-6 text-white">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span>{t('airports.eindhoven.callNow')}</span>
                                </a>
                            </motion.div>
                        </div>
                    </div>
                ...
                <section className="py-16 relative z-10">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        >
                            <h2 className="text-3xl font-bold text-white mb-4">{t('airports.eindhoven.whyChoose')}</h2>
                            <p className="text-white/80 text-lg max-w-2xl mx-auto">
                                {t('airports.eindhoven.whyChooseDesc')}
                            </p>
                        </motion.div>
                ...
                <section className="py-16 relative z-10">
                    <div className="max-w-7xl mx-auto px-4">
                        <motion.div
                            ...
                            className="text-center mb-12"
                        >
                            <h2 className="text-3xl font-bold text-white mb-4">{t('airports.eindhoven.popularRoutes')}</h2>
                            <p className="text-white/80 text-lg">{t('airports.eindhoven.popularRoutesDesc')}</p>
                        </motion.div>
                ...
                <section className="py-16 relative z-10">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            >
                                <h2 className="text-3xl font-bold mb-6">{t('airports.eindhoven.aboutTitle')}</h2>
                                <div className="space-y-4 text-white/90">
                                    <p>
                                        {t('airports.eindhoven.aboutDesc1')}
                                    </p>
                                    <p>
                                        {t('airports.eindhoven.aboutDesc2')}
                                    </p>
                                </div>
                                ...
                                <div className="mt-8 grid grid-cols-2 gap-6">
                                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                                        ...
                                        <h3 className="font-semibold mb-1">{t('airports.eindhoven.location')}</h3>
                                        <p className="text-sm text-white/80">{t('airports.eindhoven.locationDesc')}</p>
                                    </div>
                                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                                        <Plane className="w-6 h-6 text-secondary mb-2" />
                                        <h3 className="font-semibold mb-1">{t('airports.eindhoven.terminals')}</h3>
                                        <p className="text-sm text-white/80">{t('airports.eindhoven.terminalsDesc')}</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <h3 className="text-2xl font-bold text-white mb-6">{t('airports.eindhoven.amenities')}</h3>
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 text-white/90">
                                        <Wifi className="w-5 h-5 text-secondary" />
                                        <span>{t('airports.eindhoven.wifi')}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-white/90">
                                        <Coffee className="w-5 h-5 text-secondary" />
                                        <span>{t('airports.eindhoven.restaurants')}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-white/90">
                                        <Luggage className="w-5 h-5 text-secondary" />
                                        <span>{t('airports.eindhoven.luggageStorage')}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-white/90">
                                        <Star className="w-5 h-5 text-secondary" />
                                        <span>{t('airports.eindhoven.dutyFree')}</span>
                                    </div>
                                </div>

                                <div className="mt-6 p-4 bg-secondary/20 rounded-xl">
                                    <h4 className="font-semibold text-white mb-2">{t('airports.eindhoven.pickupLocation')}</h4>
                                    <p className="text-white/80 text-sm">
                                        {t('airports.eindhoven.pickupLocationDesc')}
                                    </p>
                                </div>
                            </motion.div>
                        </div>
