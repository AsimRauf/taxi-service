            ...
            <div className="w-[95%] md:w-[90%] max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center px-4 md:px-0">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.5 }}
                        className="relative h-[300px] md:h-[400px] rounded-xl overflow-hidden my-4 md:my-0"
                    >
                        <Image
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.5 }}
                        className="py-4 md:py-0 px-2 md:px-0"
                    >
                        <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-6 text-primary">
                            {translations.features.heading}
                        </h2>
                        <div className="space-y-4 md:space-y-4 text-gray-600 text-base md:text-base">
